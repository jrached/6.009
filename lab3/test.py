...
###-----------------------Additional Tests-------------------------
def my_test_acted_together():
    actor1 = 4724
    actor2 = 2876
    assert lab.acted_together(db_tiny, actor1, actor2)

def my_bacon_number_test_1():
        assert lab.actors_with_bacon_number(db_tiny, 0) == {4724}

def my_bacon_number_test_2():
        assert lab.actors_with_bacon_number(db_tiny, 1) == {2876, 1532}
        
def my_bacon_number_test_3():
        assert lab.actors_with_bacon_number(db_tiny, 2) == {1640}
    
def my_bacon_number_test_4():
        assert lab.actors_with_bacon_number(db_tiny, 3) == set()
        
def my_bacon_path_test():
    assert lab.bacon_path(db_tiny, 1640) == [4724, 2876, 1640]
    
def my_actor_paths_tests():
    assert lab.actor_to_actor_path(db_tiny, 2876 , 1640) == [2876, 1640]
